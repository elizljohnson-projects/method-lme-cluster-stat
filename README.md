...
- Use cluster_2way for models with two fixed effects and their interaction. It was designed for the fixed effects of (1) hit vs. miss on a memory task and (2) brain region, and may be u as a plate for models with more than t fixed effects and/or fixed effects with more than two levels.
